        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">CA 0.1</a>
                </div>
                <!-- /.navbar-header -->
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">                            
                            <li>
                                <a href="template.php"><i class="fa fa-home fa-fw"></i> Home</a>
                            </li>

                            <li>
                                <a href="?p=page-ca2"><i class="fa fa-bar-chart-o fa-fw"></i> Dados Gerais</a>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li class="disabled"><a href="#">Supervisor</a></li>                                    
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <!--<li class=""><a href="?p=page9">Notas</a></li>-->
                                    <li class="disabled"><a href="#">Relatório 4</a></li> 
                                </ul>
                            </li>                               
                        </ul>
                    </div>
